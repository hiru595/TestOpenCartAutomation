...
public class TC2_ForgotPassword extends CommonToAllTests {

    @Test
    @Description //Invalid email id

    public void ForgotPasswordTC_2() throws InterruptedException {
        ...
        Thread.sleep(2000);
        forgotPasswordPage.enterForgotPwEmail(propertiesReader.readKey("InValidEmail_Forgotpassword1"));
