...
public class TC5_UserRegistration extends CommonToAllTests {

    @Test
    @Description //Invalidformat of Email and Password
    public void UserRegTC_5() throws InterruptedException {
        ...
        userReg.EmailId(propertiesReader.readKey("invalidEmail2"));
        userReg.Password(propertiesReader.readKey("invalidPassword2"));
