...
public class TC8_UserRegistration extends CommonToAllTests {

    @Test
    @Description //Invalidformat of Email and Password
    public void UserRegTC_8() throws InterruptedException {
        ...
        userReg.EmailId(propertiesReader.readKey("invalidEmail5"));
        userReg.Password(propertiesReader.readKey("invalidPassword5"));
