...
public class TC7_UserRegistration extends CommonToAllTests {

    @Test
    @Description //Invalidformat of Email and Password
    public void UserRegTC_7() throws InterruptedException {
        ...
        userReg.EmailId(propertiesReader.readKey("invalidEmail4"));
        userReg.Password(propertiesReader.readKey("invalidPassword4"));
