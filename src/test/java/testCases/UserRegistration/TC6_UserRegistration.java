...
public class TC6_UserRegistration extends CommonToAllTests {

    @Test
    @Description //Invalidformat of Email and Password
    public void UserRegTC_6() throws InterruptedException {
        ...
        userReg.EmailId(propertiesReader.readKey("invalidEmail3"));
        userReg.Password(propertiesReader.readKey("invalidPassword3"));
